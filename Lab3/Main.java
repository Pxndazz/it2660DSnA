public class Main {
  public static void main(String[] args) {
    ...
    String bestCase = "A"; 
    /* I decided to make sure there was a match for the 
    best case rather than using a pattern longer than the above text pattern.
    */
    ...
    System.out.println("The difference in time in best-case input is " + (endTime - startTime) + " nanoseconds");
    ...
    System.out.println("The difference in time in worst-case input is " + elapsedTime + " nanoseconds");
